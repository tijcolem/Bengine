Bengine.extensibles.python2 = new function Python2() {
	...
	this.insertContent = function(block,bcontent) {
		...
		pyBlock.setAttribute("class","xPyx");
		...
		if(thisBlock.p.emptyObject(bcontent)) {
			if(thisBlock.d.options.defaultText) {
				text = 'This is a CodeMirror text editor. Use it to add & run your Python 2.7 code.\n';
			}
		} else {
	...
	this.showContent = function(block,bcontent) {
	    var pyBlock = document.createElement("div");
		pyBlock.setAttribute("class","xSgx-show");
